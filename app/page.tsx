    ...
    >
      <div className="bg-white/80 backdrop-blur-md rounded-xl p-6 shadow-lg w-full max-w-lg">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <Link href="/search" className="group flex items-center gap-3 bg-blue-100 hover:bg-blue-200 p-4 rounded-lg shadow transition">
          ...
          <Link href="/work" className="group flex items-center gap-3 bg-red-100 hover:bg-red-200 p-4 rounded-lg shadow transition">
