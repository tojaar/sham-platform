              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'start' }}>
                <div>
                  ...
                  <div style={{ marginTop: 8, fontSize: 13, lineHeight: 1.45 }}>
                    ...
                    <div>3.الصق العنوان ثم انقر على اضهر الحساب  .</div>
                    <div>4.انقر على ارسال ثم اختر نوع العملة سوري ثم حدد المبلغ 20,000 ل.س وانقر ارسال  .</div>
                    <div>5.بعد عملية الدفع اذهب الى التحويلات ستجد في السجل رقم العملية يبدأ ب # انسخه  .</div>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'start' }}>
                <div>
                  ...
                  <div style={{ marginTop: 8, fontSize: 13, lineHeight: 1.45 }}>
                    ...
                    <div>4. بعد تأكيد المعاملة انسخ  معرف المعاملة أو TXID من السجلات.</div>
