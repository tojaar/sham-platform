            ...
            {selectedPayment === 'sham' && (
              <div className="payment-panel sham" role="region" aria-label="شام كاش">
                ...
                <ol style={{ marginTop: 10, paddingLeft: 18, color: '#7c2d12', fontSize: 13 }}>
                  ...
                  <li>اذهب الى شام كاش ثم انقر على ارسال ثم الصق العنوان ثم ارسل 10,000 ل.س  .</li>
                  <li>بعد إتمام الدفع اذهب الى التحويلات ستجد في السجلات رقم عملية الدفع تبدأ # انسخه.</li>
                  <li> ثم ضعه في حقل رمز الدفع هنا في الاسفل.</li>
                </ol>
            ...
            {selectedPayment === 'usdt' && (
              <div className="payment-panel usdt" role="region" aria-label="USDT">
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'start', gap: 12 }}>
                  <div>
                    ...
                    <div style={{ marginTop: 6, fontSize: 13, color: '#064e3b' }}>
                      انسخ رابط الدفع أو عنوان المحفظة ثم أرسل المبلغ عبر شبكة TRC20. بعد التأكيد أدخل TXID في حقل معرف الدفع هنا في الاسفل.
                    </div>
                  </div>
                ...
                <ol style={{ marginTop: 10, paddingLeft: 18, color: '#064e3b', fontSize: 13 }}>
                  ...
                  <li>بعد تأكيد المعاملة انسخ TXID وأدخله في حقل معرف الدفع هنا Iفي الاسفل .</li>
                </ol>
