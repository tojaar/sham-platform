...
export default function SeekerPage(): JSX.Element {
      ...
      <form onSubmit={handleSubmit} style={{
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
          ...
          <div style={{ height: 220, borderRadius: 8, overflow: 'hidden', border: '1px solid #fde68a' }}>
            <MapPicker onSelect={(coords: { lat: number; lng: number }) => {
...
function Field({ icon, placeholder, value, onChange, type = 'text' }: {
  ...
  return (
    <label style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
      <span style={{ fontWeight: 'bold', color: '#92400e' }}>{icon} {placeholder}</span>
      <input
        type={type}
        value={value}
