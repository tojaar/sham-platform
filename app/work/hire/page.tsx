              ...
              <div className="flex justify-between items-start gap-4">
                <div>
                  ...
                  <div className="text-sm text-[#7c2d12] mt-1">
                    انسخ عنوان شام كاش ثم اذهب الى محفظتك وارسل 10,000 ل,س الى العنوان الذي نسخته ثم ادخل الى السجلات سوف تجد رقم عملية الدفع التي تبدأ ب # انسخه وضعه في الحقل المخصص ادناه.
                  </div>
                </div>
